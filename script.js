...
function initTyped() {
  ...
  const texts = ['Full Stack Developer', 'Python Developer', 'Web Developer', 'Problem Solver', 'Tech Enthusiast'];
...
function sendViaGmail() {
  ...
  const gmailUrl = `https://mail.google.com/mail/?view=cm&to=mhemanthkumarreddy0@gmail.com&su=${encodeURIComponent(subject)}&body=${encodeURIComponent(fullBody)}`;
